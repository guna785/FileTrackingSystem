...
namespace FileTrackingSystem.BL.SchemaModel
{
    public class JobTypeSchema
    {
        ...
        [GSchema("documentRequired", "Document Required", "string", true,getEnumVal ="docReq", getHtmlClass = "col-md-12", getfieldHtmlClass = "select2 selectMultiple")]
        public dynamic documentRequired { get; set; }
